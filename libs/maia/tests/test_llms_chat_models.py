...
from maia.base.schema import AIMessage, HumanMessage, LLMInterface, SystemMessage
from maia.llms import AzureChatOpenAI, LlamaCppChat
...
def test_azureopenai_model():
    ...
    with patch(
        ...
        side_effect=lambda *args, **kwargs: make_chat_completion_response(),
